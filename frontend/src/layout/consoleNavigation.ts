...
const DEFINITIONS: Record<ConsoleKind, Array<Omit<ConsoleNavigationItem, 'to'>>> = {
  platform: [
    ...
    { segment: 'templates', label: 'Templates', capability: 'platform.templates.manage' },
    { segment: 'creation-requests', label: 'Creation requests', capability: 'platform.workspace_creation_requests.manage' },
