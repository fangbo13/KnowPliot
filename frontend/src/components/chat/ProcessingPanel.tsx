...
interface ProcessingPanelProps {
  ...
  citations: Citation[];
  /** Read-only server snapshot; reserved for future use, not displayed to users. */
...
export default function ProcessingPanel({
  ...
  timings = {},
  citations,
  executionSnapshot: _executionSnapshot = null,
  snapshot: _snapshot = null,
  effectiveSnapshot: _effectiveSnapshot = null,
